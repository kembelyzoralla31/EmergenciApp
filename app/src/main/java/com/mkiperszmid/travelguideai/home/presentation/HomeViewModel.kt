    ...
    fun onSettingsChange(action: HomeFilterDialogAction) {
        when (action) {
            ...
            HomeFilterDialogAction.OnMuseumClick -> {
                state = state.copy(
                    filterSettings = state.filterSettings.copy(
                        veterinarias = !state.filterSettings.veterinarias
                    )
                )
            }
            ...
            HomeFilterDialogAction.OnRestaurantClick -> {
                state = state.copy(
                    filterSettings = state.filterSettings.copy(
                        hospitales = !state.filterSettings.hospitales
                    )
                )
            }

            HomeFilterDialogAction.OnApplyClick -> TODO()
            HomeFilterDialogAction.OnMuseumClick -> TODO()
            HomeFilterDialogAction.OnPeopleMinus -> TODO()
            HomeFilterDialogAction.OnPeoplePlus -> TODO()
            HomeFilterDialogAction.OnRestaurantClick -> TODO()
        }
    }
